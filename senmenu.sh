...
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/xlord27/Autoscript-vpn-main/main/running.sh"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/xlord27/Autoscript-vpn-main/main/issue.net"
