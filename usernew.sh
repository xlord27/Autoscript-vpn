...
echo -e ""
echo -e "${CYAN}═══════════════════════════════════════════════\033[0m${NC}"
echo -e "\E[44;1;39m                 ⇱ THANKS FOR ORDER ⇲            \E[0m"
echo -e "${CYAN}════════════════════════════════════════════════\033[0m${NC}"
...
echo -e "════════════════════════════"
echo -e "GET wss://$domain/ HTTP/1.1[crlf]Host: xlord.com[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "════════════════════════════"
echo -e "Payload Websocket HTTP"
echo -e "════════════════════════════"
echo -e "GET / HTTP/1.1[crlf]Host: $domain[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "════════════════════════════"
echo -e "${CYAN}       • XLORD VPN STORE •" 
echo -e "${CYAN}         t.me/xlordeuyy"
echo -e "${LIGHT}═══════════════════════"
