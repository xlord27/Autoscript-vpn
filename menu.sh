...
clear
echo -e "\033[0;34m╒═════════════════════════════════════════════════════════════╕
      ${NC}Welcome To ${GREEN}XLORD ${NC}Script installer ${GREEN}( SIMPEL VERSION )
...
echo -e "\033[0;34m╒═════════════════════════════════════════════════════════════╕\033[0m${NC}"
echo -e "$COLOR1  \033[0m ${BOLD}${YELLOW}SSH          VMESS             VLESS               TROJAN$NC  $COLOR1"
...
echo -e "  ✪$bd Status Hari ini  : jangan lupa sholat"
echo -e "\033[0;34m╒═════════════════════════════════════════════════════════════╕\033[0m${NC}"
...
echo -e "\033[0;34m╒═════════════════════════════════════════════════════════════╕\033[0m${NC}"
echo -e " \E[41;1;39m                ⇱ XLORD PROJECT TUNNELING ⇲                   \E[0m"
echo -e "\033[0;34m╘═════════════════════════════════════════════════════════════╛\033[0m${NC}"
