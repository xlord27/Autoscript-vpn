...
#######PERIZINAN
BURIQ () {
    curl -sS https://raw.githubusercontent.com/xlord27/Xray-SSH/main/permission/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/xlord27/Xray-SSH/main/permission/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/xlord27/Xray-SSH/main/permission/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/xlord27/Xray-SSH/main/permission/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m                     ⇱ XLORD PROJECT TUNNELING ⇲                         \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
